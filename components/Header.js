...
//import { useDomElementsContext } from '@/context/DomElementsContext';
...
const Header = () => {
    ...
    console.log("dom element data 22222222222", domElementContextData);
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center justify-start">
                                <button onClick={() => {
                                            ...
                                            console.log("dom element data", domElementContextData);
                                            
                                            domElementContextData.toggleSidebar();


                                            //toggleSidebarMobile(sidebar, sidebarBackdrop, toggleSidebarMobileHamburger, toggleSidebarMobileClose);
                                        }}
                                id="toggleSidebarMobile" aria-expanded="true" aria-controls="sidebar" className="lg:hidden mr-2 text-gray-600 hover:text-gray-900 cursor-pointer p-2 hover:bg-gray-100 focus:bg-gray-100 focus:ring-2 focus:ring-gray-100 rounded">
